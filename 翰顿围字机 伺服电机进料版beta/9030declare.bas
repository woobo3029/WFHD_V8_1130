...
'/******************************************************************************
 '*
 '* 函数名   : LM_SetPauseTime_9030
 '* 函数编号 : 125

 '* 描述   : 设置插补暂停停止时间  固件5.2版

' * 参数   :
    
'      Board_NO : 0－3, 板号

'        Time    : 30-2000; 暂停停止时间;单位:毫秒;缺省值: 30
...
' *
' *****************************************************************************/
Declare Function LM_SetPauseTime_9030 Lib "dfjzh9030dll.dll" (ByVal Board_NO As Integer, ByVal Time As Integer) As Integer
...
' *
' *****************************************************************************/
Declare Function UnlockFlash_9030 Lib "dfjzh9030dll.dll" (ByVal Board_NO As Integer, ByVal password1 As Long, ByVal password2 As Long) As Integer
...
' *
' *****************************************************************************/
Declare Function LockFlash_9030 Lib "dfjzh9030dll.dll" (ByVal Board_NO As Integer, ByVal password1 As Long, ByVal password2 As Long) As Integer
...
' *
' *****************************************************************************/
Declare Function WriteFlash_9030 Lib "dfjzh9030dll.dll" (ByVal Board_NO As Integer, ByVal offset As Integer, ByVal length As Integer, ByVal word1 As Long, ByVal word2 As Long) As Integer
...
' *
' *****************************************************************************/
Declare Function WriteFlashChar_9030 Lib "dfjzh9030dll.dll" (ByVal Board_NO As Integer, ByVal offset As Integer, ByVal length As Integer, ByRef Data As Long) As Integer
...
' *
' *****************************************************************************/
Declare Function UpDateFlash_9030 Lib "dfjzh9030dll.dll" (ByVal Board_NO As Integer) As Integer
...
' *
' *****************************************************************************/
Declare Function ReadFlash_9030 Lib "dfjzh9030dll.dll" (ByVal Board_NO As Integer, ByVal offset As Integer, ByVal length As Integer) As Long
...
' *
' *****************************************************************************/
Declare Function ReadFlashChar_9030 Lib "dfjzh9030dll.dll" (ByVal Board_NO As Integer, ByVal offset As Integer, ByVal length As Integer, ByRef Data As Long) As Integer
